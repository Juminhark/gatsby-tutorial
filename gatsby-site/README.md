...
4.  **`.prettierrc`** : [Prettier](https://prettier.io/).

5.  **`gatsby-browser.js`** :[Gatsby browser APIs](https://www.gatsbyjs.org/docs/browser-apis/). These allow customization/extension of default Gatsby settings affecting the browser.

6.  **`gatsby-config.js`** : [config docs](https://www.gatsbyjs.org/docs/gatsby-config/)

7.  **`gatsby-node.js`** : [Gatsby Node APIs](https://www.gatsbyjs.org/docs/node-apis/). These allow customization/extension of default Gatsby settings affecting pieces of the site build process.

8.  **`gatsby-ssr.js`** :[Gatsby server-side rendering APIs](https://www.gatsbyjs.org/docs/ssr-apis/). These allow customization of default Gatsby settings affecting server-side rendering.

9.  **`LICENSE`**

10. **`package-lock.json`** : **(You won’t change this file directly).**

11. **`package.json`**

12. **`README.md`**

## 🎓 [Learning Gatsby](https://www.gatsbyjs.org/)
